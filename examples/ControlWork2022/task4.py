...
"""
import numpy as np
from pame.JFET.calculations import volt_amper_characteristics, Ip, Vp, g_m, g_d
...
def run():
    ...
    volt_amper_characteristics(I_p=ip, path='examples/ControlWork2022/', vp=vp, ug=np.array([0, vp/2]))
